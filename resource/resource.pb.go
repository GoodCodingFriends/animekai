...
type Profile struct {
	...
	AvatorUrl string `protobuf:"bytes,1,opt,name=avator_url,json=avatorUrl,proto3" json:"avator_url,omitempty"`
...
func (x *Profile) GetAvatorUrl() string {
	if x != nil {
		return x.AvatorUrl
	}
	return ""
...
var file_resource_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x76, 0x61, 0x74, 0x6f,
	0x72, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x76, 0x61,
	0x74, 0x6f, 0x72, 0x55, 0x72, 0x6c, 0x12, 0x23, 0x0a, 0x0d, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64,
